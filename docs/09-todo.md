...
> Next 候选 = **HW-2.5 真机联调**（HW-0/1/2 Done：翻译层待对真臂 B 验收）/ E6–E7（blocked 待 PMS API）（桌面键鼠遥操真机，黑盒对接仓外 arm-bridge；[28](28-hw-real-robot-plan.md)，可立即开）/ E6–E7（blocked：待 PMS API）。  
